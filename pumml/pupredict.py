...
class PUPredict:
    ...
    def _extract_features(df_input):
      ...
      """
        ...
        if df_extracted.shape[0] < df_input.shape[0]:
            logging.warning("Some compounds have not been featurized")
    ...
    def get_synth_score_from_material_id(self, func_input, api_key):
    ...
    def get_synth_score_from_formula(self, func_input, api_key):
    ...
    def get_synth_score_from_structure(self, func_input, api_key):
